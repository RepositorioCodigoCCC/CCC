...
BD=pd.read_excel("2. UEC_CONSOLIDADO _VENTAS_2022.xlsx",dtype={'NOMBRE':object, 'MATRICULA': object, 'NIT':object,'CLUSTER': object,'CIUDAD': object})
BD.info()
BD.head()
...
#Cumplimiento de relaciones dentro de la Base de Datos. Por ejemplo, las comunas de Cali no pueden tomar el valor de Comuna 80.
#Las relaciones inter-relación es entre bases de datos
nit_error_nit1=len(BD)-sum(BD["exists"]==1)

nit_consistencia=1-(nit_error_nit1/len(BD))
nit_consistencia
